    ...
    <Card>
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-semibold text-gray-900 font-display">Agregar Productos</h3>
          {!selectedClient && (
        ...
        <div className="relative">
          ...
          <input
            ...
            autoComplete="off"
            className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 disabled:bg-gray-50 disabled:text-gray-500"
          />
        </div>
            ...
            <div className="space-y-2 max-h-96 overflow-y-auto">
              {filteredProducts.map((product) => {
                ...
                return (
                  <div
                    key={product.id}
                    className="flex items-center gap-3 p-3 border border-gray-200 rounded-xl hover:border-primary-300 hover:bg-primary-50 transition-colors group"
                  >
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        {product.category && (
                          <span className="text-xs bg-gray-100 text-gray-600 px-1.5 py-0.5 rounded-lg whitespace-nowrap">
                            {product.category.name}
                          </span>
                        )}
                      </div>
                      <div className="flex items-center gap-2 mt-2 flex-wrap">
                        <span className="text-xs font-semibold bg-secondary-100 text-secondary-700 px-2 py-0.5 rounded-lg">
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      <input
                        ...
                        className="w-14 px-2 py-1 text-sm border border-gray-200 rounded-lg text-center focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 group-hover:border-primary-300"
                      />
                      <Button
                        size="sm"
